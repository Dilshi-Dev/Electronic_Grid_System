...
public String addUser(String name, String contact, String email, String password,String username,String role)
 {
 String output = "";
 try
 {
...
public String getAllUsers()
 ...
 output = "<table border='1'><tr><th>User Name</th><th>Contact Number</th>" + "<th>Email</th>" + "<th>Password</th>" +"<th>Username</th>" +"<th>Role</th>" +"<th>Update</th><th>Remove</th></tr>";
 ...
 output += "<td>" + role + "</td>";
 // buttons
 output += "<td><input name='btnUpdate' type='button' value='Update'class='btn btn-secondary'></td>"+ "<td><form method='post' action='users.jsp'>"+ "<input name='btnRemove' type='submit' value='Remove'class='btn btn-danger'>"+ "<input name='id' type='hidden' value='" + id+ "'>" + "</form></td></tr>";}
 con.close();
